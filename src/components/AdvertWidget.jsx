  ...
  return (
    <WidgetWrapper>
      <div className="flex items-center justify-between py-2">
        <span className="text-sm text-black/40">Sponsored</span>
        <span className="text-sm text-black/40">Create Ad</span>
      </div>
      <img src={imageAddress} alt="ad" />
      <div className="flex items-center justify-between py-2">
        <span className="text-sm">Nature's glow</span>
        <span className="text-sm font-bold text-black/60">glow@gmail.com</span>
      </div>
